...
if __name__ == "__main__":
  ...
  for train_ix, test_ix in kfold.split(idx, labels):
    ...
    args.save_name = '_'.join([args.model, str(args.epoch_number), str(args.batch_size), args.optimizer, args.criterion, str(args.pretrain), 'sabdab', 'old_split', 'norep', 'cross', str(count), 'no_weights'])
    count += 1
